...
public class UtenteDAO {
    ...
    public void save(UtenteBean utente) throws SQLException {
        ...
        try {
            ...
            preparedStatement.setDate(4, Date.valueOf(utente.getDataDiNascita())); // Conversione LocalDate -> Date
        ...
        try {
            ...
            if (resultSet.next()) {
                ...
                return new UtenteBean(
                    ...
                    resultSet.getDate("data_di_nascita").toLocalDate(), // Conversione Date -> LocalDate
                    resultSet.getString("email"),
                    resultSet.getString("pw"),
                    resultSet.getInt("num_timeout"),
                    resultSet.getBoolean("is_timeout"),
                    resultSet.getBoolean("is_admin"),
                    resultSet.getTimestamp("data_ora_fine_timeout").toLocalDateTime().toLocalDate(), // Conversione Timestamp -> LocalDate
