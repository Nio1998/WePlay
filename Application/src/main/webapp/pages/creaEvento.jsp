...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/CSS/creaEvento.css">
    <!-- Script per la validazione -->
    <script src="${pageContext.request.contextPath}/JS/validateCreaEvento.js" defer></script>
</head>
<body>
    <!-- Import della navbar -->
    ...
    <main class="main-content">
        <section class="crea-evento-section">
            ...
            <div class="crea-evento-box">
                <form action="${pageContext.request.contextPath}/creaEventoServlet" method="post" id="creaEventoForm">
                    <div class="form-group">
                        <input type="text" name="titolo" id="titolo" placeholder="Titolo" required>
                    </div>
                    <div class="form-group">
                        <input type="text" name="sport" id="sport" placeholder="Sport" required readonly>
                        <div id="sportOptions" class="dropdown-options" style="display: none;">
                            ...
                            <div class="option" onclick="selectSport('Ping Pong')">Ping Pong</div>
                            <div class="option" onclick="selectSport('Badminton')">Badminton</div>
                            <div class="option" onclick="selectSport('Golf')">Golf</div>
                            <div class="option" onclick="selectSport('Beach Volley')">Beach Volley</div>
                    ...
                    <div class="form-group">
                        <input type="number" name="partecipanti" id="partecipanti" placeholder="Partecipanti Massimi" required min="2">
                    </div>
                    <div class="form-group">
                        <input type="number" name="prezzo" id="prezzo" placeholder="Prezzo" required min="0" step="0.01">
                    </div>
